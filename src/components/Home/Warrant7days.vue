<template>
  <v-row style="background-color: #161616" class="align-center">
    <v-col md="6">
      <v-img
    ...
    <v-col cols="12" md="4" class="text-md-left text-center">
      ...
      <div>
        Ao adquirir um de nossos cursos, você terá 7 dias para testar o material
        e decidir se é a escolha certa para você.
        <br /><br />

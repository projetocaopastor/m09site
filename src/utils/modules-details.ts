...
export const modules = ref([
  ...
  },
  {
    ...
    contents: [
      { "Aula 01": "Entendendo o Crime" },
      { "Aula 02": "Leitura de Ambiente" },
      { "Aula 03": "Leitura Corporal" },
      { "Aula 04": "Medidas: Proxêmica" },
      { "Aula 05": "Medidas: Desescalar" },
      { "Aula 06": "Medidas: Escala de Prioridade" },
      { "Aula 07": "Medidas: Run, Hide, Fight" },
      { "Aula 08": "Medidas: Cobertas e Abrigos" },
      { "Aula 09": "Medidas: Teoria do Cardume" },
      { "Aula 10": "Medidas: Crise" },
    ],
  },
  {
